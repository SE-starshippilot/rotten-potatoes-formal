...
\begin{enumerate}
    ...
    \item Traverse through the chart. For every movie within the chart:
    \begin{enumerate}
        ...
        \begin{itemize}
            \item Access the detailed director page, where information regarding the director can be found.
        \end{itemize}
        \item From the detailed movie page, we can also access the actors/actresses who casted in this movie. For each actor/actress:
        \begin{itemize}
            \item If the actor/actress's information is yet to be recorded, access the detailed actor/actress page and find detailed information.
        \end{itemize}
        \item The comment section locates at the bottom of the movie page.
    \end{enumerate}
\end{enumerate}
